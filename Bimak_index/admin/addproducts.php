			...
			if(isset($name) && !empty($name)){
				if(($extension == "jpg" || $extension == "jpeg" || $extension == "png"|| $extension == "PNG") && ($type == "image/PNG" ||$type == "image/png" || $type == "image/jpeg") && $size<=$max_size){
					...
					if(move_uploaded_file($tmp_name, $location.$name)){
						...
						$sql = "INSERT INTO products (name, description, categoryid, price, thumbneil,qty) VALUES ('$prodname', '$description', '$category', '$price', '$location$name','$qty')";
			...
			<form method="post" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
			    ...
			    <input type="number" class="form-control" name="qty" id="productqty" placeholder="Product quantity">
			  </div>
