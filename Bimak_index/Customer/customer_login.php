                        ...
                        <div class="login-form">
                            <form action="php/customer_login.php" method="post">
                                ...
                                <div class="login-checkbox">
                                    ...
                                    <label>
                                        <a href="customer_resetpassword.php">Forgotten Password?</a>
                                    </label>
                                </div>
...
<form action="php/customer_login.php" method="post">
  ...
  <br><br>
  <a href="customer_resetpassword.php">Forgot your password.?</a>
  <br><br>
  <input type="submit" value="SIGN IN">
  <br><br>
  <a href="customer_register.php">Don't have an account.? Sign Up</a>
</form> 

<p>If you click the "SIGN IN" button, the form-data will be sent to a page called "php/customer_login.php".</p>-->