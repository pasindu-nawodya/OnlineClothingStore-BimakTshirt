                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="images/customer/logo.jpg" alt="CoolAdmin">
                            </a>
                        </div>
                        <br>
                        <h4>We will send you an email to reset your password.</h4><br>
                        <div class="login-form">
                            <form action="php/customer_login.php" method="post">
...
<form action="php/customer_resetpassword.php" method="post">
...
<p>If you click the "SUBMIT" button, the form-data will be sent to a page called "php/customer_resetpassword.php".</p>-->