                    ...
                    <div class="container-fluid">
                        <div class="row">
							...
							<div class="overview-wrap">
                                   <center> <h1><i class="fas fa-user"></i> &nbsp Admin Page</h1> </center>
                                </div>
								<hr><br>
                            </div>
                        </div>
                        ...
                        <?php
                            ...
                            $conn = new mysqli("localhost","root","1234","bimak");
                                    ...
                                    <center>
                                        <form action='php/admin_update.php' method='post' enctype='multipart/form-data' class='form-horizontal' >
                                            ...
                                            <img src='$loc$photo' width='100px' height='100px' style='border-radius:50px'><br>
                                            <br>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='name' value='$name' class='form-control' required>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='username' value='$username' class='form-control' required>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='email' id='text-input' name='email' value='$email' class='form-control' required>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='password' id='text-input' name='password' value='$password' class='form-control' required>
                                                </div>
                                            </div>                                                                                    
