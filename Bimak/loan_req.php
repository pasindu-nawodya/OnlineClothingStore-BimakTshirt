        ...
        <div class="page-container">
            ...
            <div class="main-content">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="overview-wrap">
                                   <center> <h1><i class="fas fa-list-alt"></i>Requested Loan Details</h1> </center>
                                </div>
                                <hr><br>
                            </div>
                        </div>
                ...
                if(mysqli_connect_error()){
                    ...
                    $sql = "select * from loan_details s,employee e where s.emp_id=e.id";
                    ...
                    echo "
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href='loan_show.php?show=$empid'>
