        ...
        <div class="page-container">
            ...
            <div class="main-content">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="overview-wrap">
                                   <center> <h1>Customers In System</h1> </center>
								   <form class="form-header" action="customer_search.php" method="POST">
                    ...
                    echo "
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href='customer_show.php?edit=$cid'>
                                ...
                                <td>
                                    ...
                                    <div class='table-data-feature'>
                                    <a href='php/admin_customer_delete.php?del=$cid'>
                ...
                <div style="float: right;">
                	<form class="form-inline" method="post" action="customer_pdf/customer_pdf.php">
						<button type="dpwnload" id="pdf" class="btn btn-primary"><i class="fa fa-pdf"" aria-hidden="true"></i>
						Download</button>
					</form>
				</div>
