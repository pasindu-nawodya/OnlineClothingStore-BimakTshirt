            ...
            <div class="main-content">
                    ...
                    <div class="container-fluid">
                        <div class="row">
							...
							<div class="overview-wrap">
                                   <center> <h1><i class="fas fa-wheelchair"></i> &nbsp Leave Details </h1> </center>
                                </div>
								<hr><br>
                            </div>
                        </div>
                ...
                if(mysqli_connect_error()){
                    ...
                    while($row = mysqli_fetch_array($runsql)){
                        ...
                        $deff = ($end-$start)/60/60/24;

                        $tot_leave = $tot_leave + $deff;           
                   ...
                   $tot = 30- $tot_leave;
                    ...
                    echo "
                        <div class='overview-wrap'>                                              
                            ...
                            <a href='leave_req.php'><button type='button' class='btn btn-outline-primary'>
                                        <i class='fas fa-list-ol'></i> Request Leave</button></a>
                        </div>
                        <br>
                         <h4>Total leaves in Year: 30 Days</h4><br> 
                         <h4>Remaining leaves: $tot Days</h4> 
                        <br><br>
                    ...
                    echo "
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href='php/leave_delete.php?del=$id'>
