                    ...
                    <div class="container-fluid">
                        <div class="row">
							...
							<div class="overview-wrap">
                                   <center> <h1><i class="fas fa-suitcase"></i> &nbsp Loan Request</h1> </center>
                                </div>
								<hr><br>
                            </div>
                        </div>
                         ...
                         <form action="loan_req_php.php?id=1" method="post" enctype="multipart/form-data" class="form-horizontal" >
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="text-input" name="amount" placeholder="Loan Amount" class="form-control" required>
                                                  </div>
                                            </div>
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="date" id="text-input" name="loanDate" placeholder="Loan Date" class="form-control" required>
                                                  </div>
                                            </div>
                                               ...
                                               <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea id="text-input" name="reason" placeholder="Reason" class="form-control" required></textarea>
                                                  </div>
                                            </div>                                       
