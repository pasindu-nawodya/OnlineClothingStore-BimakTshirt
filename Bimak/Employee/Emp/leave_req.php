                    ...
                    <div class="container-fluid">
                        <div class="row">
							...
							<div class="overview-wrap">
                                   <center> <h1><i class="fas fa-wheelchair"></i> &nbsp Leave Request</h1> </center>
                                </div>
								<hr><br>
                            </div>
                        </div>
                         ...
                         <form action="leave_req_php.php" method="post" enctype="multipart/form-data" class="form-horizontal" >
                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="id" value="<?php echo"$id"?>" class="form-control" readonly="">
                                                  </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="leave_type" placeholder="Reason Topic" class="form-control" required>
                                                  </div>
                                            </div>
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea id="text-input" name="reason" placeholder="Reason in details" class="form-control" required></textarea>
                                                  </div>
                                            </div>  
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="date" id="text-input" name="start_date"  class="form-control" required>
                                                  </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="date" id="text-input" name="end_date"  class="form-control" required>
                                                  </div>
                                            </div>
