                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="overview-wrap">
                                   <center> <h1><i class="fas fa-rotate-right (alias)"></i> &nbsp Update Customer </h1> </center>
                                </div>
                                <hr><br>                                
                            </div>
                        </div>
                        ...
                        <?php
                            ...
                            if(isset($_GET['edit'])){
                                    ...
                                    <center>
                                        <form action='admin_customer_update.php' method='post' enctype='multipart/form-data' class='form-horizontal' >
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='firstname' value='$firstname' class='form-control' required readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='lastname'  value='$lastname' class='form-control' required readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='address' value='$address' class='form-control' required readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='number' id='text-input' name='telephone' value='$telephone'  class='form-control' required readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input'  value ='$email ' class='form-control'>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='email' id='text-input' value='$password' class='form-control'>
                                                  </div>
                                            </div>
