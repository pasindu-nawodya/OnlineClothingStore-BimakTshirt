...
<script type="text/javascript" src="js/jquery-3.4.1.min.js"></script>
    ...
    <!-- Title Page-->
    <title>Delete Deliveryman</title>
                    ...
                    <div class="container-fluid">
                        <div class="row">
						  ...
						  <center>
						    <?php
							echo"$oid";
                          $sql = "DELETE FROM employee_vehicle WHERE empId='$empId'";

                        if ($con->query($sql) === TRUE) {
                      echo "<center><h1><img src = 'images/icon/checked.png'>Succesful!!</h1><br><br><h3 align = 'center'>Record has deleted successfully.</h5><br><a href = 'delivery_assign.php'>Click here to continue</a></center>";	
                   } else {
                    echo "Error deleting record <br<a href = 'delivery_assign.php'>Try again</a> " . $con->error;
                          }
