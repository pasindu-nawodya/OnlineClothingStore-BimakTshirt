...
$vid =  $_SESSION["vId"];
$rno = $_SESSION["RegNo"];
$vtype = $_SESSION["vehicleType"];
$delivered_date = $_SESSION["delivered_date"];
$assigned_date = $_SESSION["assigned_date"];
$del_status = $_SESSION["del_status"];
                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                          ...
                          $sql = "DELETE FROM delivery_details WHERE oId='$oid'";

if ($con->query($sql) === TRUE) {
   	
 echo "<h1><img src = 'images/icon/checked.png'>Succesful!!</h1><br><br><h3 align = 'center'>Record has deleted successfully.</h5><br><a href = 'delivery_details.php'>Click here to continue</a>";	
} else {
    echo "Error deleting record <br<a href = 'delivery_details.php'>Try again</a>> " . $con->error;
}
