                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="update_success.php" method="post" enctype="multipart/form-data" class="form-horizontal">
											...
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label">Courier Service</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="text-input"  class="form-control" value = "<?php echo "$courier";?>" disabled>
