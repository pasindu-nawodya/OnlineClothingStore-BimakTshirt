                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <form method="post" action="delivery_details.php"  enctype="multipart/form-data" class="form-horizontal" target = "_self" >
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="vId" name="vId"  class="form-control" required>
								...
								<center>
								<form action = "delivery_assign_demo.php">
								<input type = "submit" value = "Demo"  class="btn btn-secondary">
								</form>
								</center>
								</center>
