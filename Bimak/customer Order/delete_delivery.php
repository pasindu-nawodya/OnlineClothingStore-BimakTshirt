...
<script type="text/javascript" src="js/jquery-3.4.1.min.js"></script>
    ...
    <!-- Title Page-->
    <title>Delete Delivery Details</title>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                      ...
                      echo "<center><h1><img src = 'images/icon/checked.png'>Succesful!!</h1><br><br><h3 align = 'center'>Record has deleted successfully.</h5><br><a href = 'delivery_details.php'>Click here to continue</a></center>";	
                   } else {
