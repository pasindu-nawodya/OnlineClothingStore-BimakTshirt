...
<body class="animsition">
    <div class="page-wrapper">
	 ...
	 <h2>&nbsp;<img src = "images/icon/order.png">Order Id:</h2><br>
        <div class="section__content section__content--p30">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12" >
                ...
                <div class="card" style = "width:70%">
                  <div class="card-header">
                    <strong class="card-title">Delivery Report</strong>
                  </div>
				 ...
				 <div class = "content">
				 <div class = "content1" style = "width:90%;text-align:left;">
				 <div class="row form-group">
				 <div class="col col-md-3">
				 <label> Order Id</label>&nbsp;&nbsp;&nbsp;&nbsp;
				 </div>
				 <input type="text" id="hf-email" name="hf-email" placeholder="Enter order Id" class="form-control" style = "border: 2px solid #dae0eb;border-radius:3px;">
				 </div>
				 ...
				 <input type="text" id="hf-email" name="hf-email" placeholder="Enter order Id" class="form-control" style = "width:50%;height:10%" >
				 </div>
