                        ...
                        <div class="row">
						  ...
						  <center>
						    <?php
									...
									$sql = "UPDATE employee_vehicle SET empId = '$emp' , Name = '$empName',vId = '$vId',vType = '$vType',RegNo = '$rNo'  WHERE empId = '$emp'";
									...
									if ($con->query($sql) === TRUE) {
									 ...
									 echo "<center><h1><img src = 'images/icon/checked.png' style = 'width:5%;'> Succesful!!</h1><br><br><h3 align = 'center'>Record has updated successfully.</h5><br></center>";
											$con = new PDO("mysql:host=localhost;dbname=bimak",'root','');
													...
													$sth = $con->prepare("SELECT * FROM `employee_vehicle` WHERE empId = '$emp'");
													...
													if($row = $sth->fetch()){
                                                           ...
                                                           echo"<div class='table-responsive m-b-40'>
																...
																echo "<tr><td>".$emp."<td>". $empName."<td>".$vId."<td>".$rNo."<td>".$vType."</td></tr></table></div>";
											
															    echo"<a href = 'delivery_assign.php'>Click here to continue</a>";
											 ...
											 echo "Error updating record <br<a href = 'delivery_assign.php'>Try again</a> " . $con->error;
