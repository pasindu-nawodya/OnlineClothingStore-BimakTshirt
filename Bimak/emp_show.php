                    ...
                    <div class="container-fluid">
                        ...
                        <?php
                            ...
                            if(isset($_GET['edit'])){
                                    ...
                                    <center>
                                        <form action='item_edit.php' method='post' enctype='multipart/form-data' class='form-horizontal' >
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='gender' value='$gender' class='form-control' readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='nic' value='$nic' placeholder='Employee NIC ' class='form-control' readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='epassword' value='$epassword'  class='form-control' readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='dob' value ='$dob ' class='form-control' readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='email' id='text-input' name='email' value='$email ' class='form-control' readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='number' id='text-input' name='phone' value='$phone' class='form-control' readonly>
                                                  </div>
                                            </div>
                                           ...
                                           <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='line1' value='$line1' class='form-control' readonly>
                                                  </div>
                                            </div> 
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='line2' value='$line2' class='form-control' readonly>
                                                  </div>
                                            </div> 
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='type' value='$type' class='form-control' readonly>
                                                  </div>
                                            </div>
                                           ...
                                           <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <textarea name='edesc' id='textarea-input' rows='9' class='form-control' readonly> $edesc</textarea>
                                                </div>
                                            </div>
