        ...
        if(isset($_POST['search']))
    {
                ...
                if(mysqli_connect_error()){
                    ...
                    echo "
                        ...
                        <div class='header-wrap'>
                             <div class='col-lg-12'>
                                <div class='table-responsive table--no-card m-b-30' align='center' &nbsp &nbsp>

                                    <table &nbsp &nbsp &nbsp &nbsp  class='table table-borderless table-striped table-earning' >
                                        <thead align='center' >
                                            <tr>
                                                <th>Employee ID</th>
                                                <th>Employee Name</th>
                    ...
                    $sql = "select * from employee where id='$check' or ename='$check' ";
