                    ...
                    <div class="container-fluid">
                        <div class="row">
                         ...
                         <a href="leave_req.php"><button type="button" class="btn btn-outline-primary">
                                        <i class="fas fa-list-ol"></i> Leave  Requests</button></a>

                            &nbsp &nbsp &nbsp &nbsp &nbsp
                            

                         <a href="loan_req.php"><button type="button" class="btn btn-outline-primary">
                                        <i class="fas fa-list-ol"></i> Loan Requests</button></a>

                             &nbsp &nbsp &nbsp   

                         <a href="sal_view.php"><button type="button" class="btn btn-outline-primary">
                                        <i class="fas fa-list-ol"></i> Salary Details</button></a>

                             &nbsp &nbsp &nbsp &nbsp &nbsp

                         <a href="sal_amount.php"><button type="button" class="btn btn-outline-primary">
                                        <i class="fas fa-list-ol"></i>Basic Salary Details</button></a>
                                            ...
                                            <div class="text">
                                                <h2>
                                                    <?php 
                                                        ...
                                                        $tot =0;
                                                         $run_edit_admin = mysqli_query($conn , $sql);
