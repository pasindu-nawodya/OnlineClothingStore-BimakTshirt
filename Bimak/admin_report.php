            ...
            <div class="main-content">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="overview-wrap">
                                   <center> <h1><i class="fas fa-clipboard"></i> &nbsp Report </h1> </center>
                                </div>
                                <hr><br>                                
                            </div>
                        </div>
                ...
                <div class="card">
                                    <div class="card-header">
                                        <strong>Click on Button to Generate Report </strong>
                                        
                                    </div>
                                    <center>
                                     <div class="card-body">
                                        <a href="fpdf/itemlistreport.php">
                                        <button type="button" class="btn btn-outline-primary btn-lg btn-block">Inventory Details Report</button>
                                    </a><br><br>
                                    <a href="emp_report.php">
                                        <button type="button" class="btn btn-outline-secondary btn-lg btn-block">Employee List Details Report</button>
                                    </a><br><br>
                                    <a href="sal_report.php">
                                        <button type="button" class="btn btn-outline-secondary btn-lg btn-block">Employee Salary Report</button>
                                    </a><br><br>
                                    <a href="customer_pdf/customer_pdf.php">
                                        <button type="button" class="btn btn-outline-primary btn-lg btn-block">Customer Details Report</button>
                                    </a><br><br>
                                    <a href="vehicle_pdf/vehiclelistrp.php">
                                        <button type="button" class="btn btn-outline-secondary btn-lg btn-block">Vehicle Details Report</button>
                                    </a><br><br>
                                    <a href="fpdf/finance_report.php">
                                        <button type="button" class="btn btn-outline-success btn-lg btn-block">Finance Details Report</button>
                                    </a><br><br>
                                    </div>
                                </div>
                            </center>
