                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <form class="form-header" action="Empsearch.php" method="POST">
                                <input class="au-input au-input--xl" type="text"  name="search" placeholder="Search for data &amp; reports..." />
                                <button class="au-btn--submit"  name="searchbtn">
                    ...
                    <div class="container-fluid">
                        <div class="row">
							...
							<div class="overview-wrap">
                                   ...
                                   <center> <h1><i class="fa fa-calendar-o"></i> &nbsp Reports</h1> </center>
                                </div>
								<hr><br>
                            </div>
                        </div>

                         <a href="fpdf/pdf.php"><button type="button" class="btn btn-outline-primary">
                                        <i class="fas fa-list-ol"></i> Employee Details Report </button></a>

                            &nbsp &nbsp &nbsp &nbsp &nbsp
                            

                         <a href="sal_report.php"><button type="button" class="btn btn-outline-primary">
                                        <i class="fas fa-list-ol"></i> Salary Report </button></a>
