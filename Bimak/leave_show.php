...
<head>
    ...
    <!-- Title Page-->
    <title>Eployee Leave Request Details</title>
                        ...
                        <?php
                            ...
                            if(isset($_GET['show'])){
                                   ...
                                   // $get_emp = "select * from employee where id = '$edit_id'";
                                    ...
                                    $get_emp = "select * from leave_details l,employee e where l.emp_id=e.id and l.emp_id = '$edit_id'";
                                    ...
                                    $id = $row_emp['emp_id'];
                                    $ename = $row_emp['ename'];
                                    $type = $row_emp['leave_type'];
                                    $Reason =  $row_emp['reason'];
                                    $sdate =  $row_emp['start_date'];
                                    ...
                                    <center>
                                        <form action='leave_submit.php' method='post' enctype='multipart/form-data' class='form-horizontal' >
                                            ...
                                            <div class='row form-group'>
                                                <div class='col col-md-3'>
                                                    <label for='select' class=' form-control-label'>Leave Type</label>
                                                </div>
                                                <div class='col-12 col-md-9'>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='sdate' value='$sdate'  class='form-control' readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='edate' value ='$edate ' class='form-control' readonly>
                                                  </div>
                                            </div>
