                    ...
                    <div class="container-fluid">
                        <div class="row">
							...
							<div class="overview-wrap">
                                   <center> <h1><i class="fas fa-rotate-right (alias)"></i> &nbsp Update Employee </h1> </center>
                                </div>
								<hr><br>                                
                            </div>
                        </div>
						...
						<?php
						   ...
						   $connect = mysqli_connect($hostname, $username, $password, $databaseName);
                            ...
                            if(isset($_GET['update'])){
                                    ...
                                    $edit_id = $_GET['update'];
                                    $get_emp = "select * from salamount where aID = '$edit_id'";
                                    ...
                                    <center>
                                        <form action='admin_basicsal_update.php' method='post' enctype='multipart/form-data' class='form-horizontal' >
                                            ...
                                            <div class='card-body card-block'>
                                             ...
                                             <div class='row form-group'>
                                                <div class='col col-md-3'>
                                                    <label for='text-input' class=' form-control-label'>Employee Designation ID</label>
                                                 </div>

                                                 <div class='col-12 col-md-9'>

                                                        <input type='text' value='$aID' name='aID' class='form-control' readonly>
                                                </div>
                                            ...
                                            <div class='row form-group'>
                                                <div class='col col-md-3'>
                                                    <label for='text-input' class=' form-control-label'>Employee Designation</label>
                                                </div>
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='empType' value='$empType' class='form-control' readonly>
                                                  </div>
                                            </div>

                                            <div class='row form-group'>
                                                <div class='col col-md-3'>
                                                    <label for='select' class=' form-control-label'>Basic</label>
                                                </div>
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='basic' value='$basic' class='form-control' >
                                                  </div>
                                            </div>
                                    ...
                                    <div class='card-footer'>
                                        ...
                                        <input type='submit'  name='Update' value='Update Basic' class='btn btn-primary btn-sm'>
                                         &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp

                                        <a href='sal_amount.php'>
