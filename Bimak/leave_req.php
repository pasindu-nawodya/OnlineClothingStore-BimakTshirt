        ...
        <div class="page-container">
            ...
            <div class="main-content">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="overview-wrap">
                                   <center> <h1><i class="fas fa-list-alt"></i>Requested Leave Details.</h1> </center>
                                </div>
                                <hr><br>
                            </div>
                        </div>
                ...
                if(mysqli_connect_error()){
                    ...
                    $sql = "select * from leave_details l,employee e where l.emp_id=e.id";
                    ...
                    echo "
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href='leave_show.php?show=$empid'>
