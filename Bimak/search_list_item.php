        ...
        <div class="page-container">
            ...
            <div class="main-content">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="overview-wrap">
                                   ...
                                   <form class="form-header" action="search_list_item.php" method="POST">
                                        <input class="au-input au-input--xl" type="text" name="search" placeholder="Search using Item id or name" />
                ...
                if(mysqli_connect_error()){
                    ...
                    $sql = "select * from products where id='$check' or name like '$check%'";
                    ...
                    echo "
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class='table-data-feature'>
                                    <a href='php/admin_item_delete.php?del=$id'>
