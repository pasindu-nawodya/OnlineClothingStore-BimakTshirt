                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="overview-wrap">
                                   <center> <h1><i class="fas fa-list-alt"></i> &nbsp Item Details </h1> </center>
                                </div>
                                <hr><br>                                
                            </div>
                        </div>
                        <?php
                            ...
                            if(isset($_GET['edit'])){
                                    ...
                                    $edit = $_GET['edit'];
                                    $get_item = "select * from products where id = '$edit'";
                                    ...
                                    $id = $row_item['id'];
                                    $iname = $row_item['name'];
                                    $iprice = $row_item['price'];
                                    $iqty = $row_item['qty'];
                                    $isize = $row_item['size'];
                                  
                                    
                                    $iphoto = $row_item['thumbneil'];
                                    $idesc = $row_item['description'];
                                        ...
                                        <form action='item_edit.php' method='post' enctype='multipart/form-data' class='form-horizontal' >
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='iname' value='$iname' class='form-control' readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='number' id='text-input' name='iprice' value='$iprice' class='form-control'  readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='number' id='text-input' name='iqty' value='$iqty' class='form-control'  readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' value='$isize' class='form-control' readonly>
                                                </div>
                                            </div> 
                                           ...
                                           <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <textarea name='idesc' id='textarea-input' rows='9' class='form-control' readonly>$idesc</textarea>
                                                </div>
                                            </div>
                                    ...
                                    <div class='card-footer'>
                                        <a href='item_edit.php?id=$id'>
                                        <button  class='btn btn-primary btn-sm'>
                                            Update
                                        </button></a> &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp

                                        <a href='fpdf/itemreport.php?edit=$id'>
                                        <button  class='btn btn-primary btn-sm' style='background-color:green'>
                                            Report
                                        </button></a> &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp
