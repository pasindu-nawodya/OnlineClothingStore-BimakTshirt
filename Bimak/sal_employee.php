                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="overview-wrap">
                                   <center> <h1><i class="fas fa-plus"></i> &nbsp Salary Calculation </h1> </center>
                                </div>
                                <hr><br>                                
                            </div>
                        </div>                   
                        ...
                        <div style="width:65%;border-radius:25%;">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Salary calculations of employees</strong>
                                    </div>
                                    <div class="card-body card-block">
											...
											<div class="row form-group">
                                                    ...
                                                    <label for="text-input" class=" form-control-label">Employee ID</label>
                                                        ...
                                                        <select name="empID" class="form-control">
                                                            ...
                                                            <?php
                                                                ...
                                                                $con=mysqli_connect("localhost","root","1234","bimak");
                                                                ...
                                                                {   
                                                                    ...
                                                                    <option value='". $row['id'] ."' '". $row['ename']."' '". $row['type']."'>
                                                                    " .$row['id'] ." &nbsp- " .$row['ename']. " &nbsp- ".$row['type']."  
											 ...
											 <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <!--<input type="number"  name="basic" placeholder="Basic salary amount " class="form-control" required> -->
                                                        <select name="basic" class="form-control">
                                                        
                                                            <?php

                                                                $con=mysqli_connect("localhost","root","1234","bimak");
                                                                $sql = mysqli_query($con, "SELECT * From salamount");
                                                                $row = mysqli_num_rows($sql);
                                                                ...
                                                                {   
                                                                    ...
                                                                    <option value='". $row['basic'] ."' '". $row['empType']."'>
                                                                    " .$row['basic'] ." &nbsp- " .$row['empType'] ."  
											 ...
											 <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number"  name="bonus" placeholder="Bonus amount " class="form-control" required>
                                                  </div>
                                            </div>
											 <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label">Bonus Type</label>
                                                </div>
                                                
											<div class="col-12 col-md-9">
                                                    <select name="bonusType"  class="form-control">
                                                        <option value="newYear">New Year Bonus</option>
                                                        <option value="yearEnd">Year End Bonus</option>
											 ...
											 <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" name="deduction"  placeholder="Deduction amount" class="form-control" required>
                                                  </div>
                                            </div>

                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label">Deduction Type</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <select name="deductionType"  class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="date" id="text-input" name="sdate" placeholder="Salary Date " class="form-control" required>
                                                  </div>
                                            </div>
									...
									<div class="card-footer">
                                        ...
                                        <!--<button type="submit" name="calcSlary" class="btn btn-danger btn-sm">
                                            Calculate
                                        </button>--> &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp
										
                                        <input type="submit" name="calcSlary" class="btn btn-primary btn-sm" value="Calculate Salary">
