                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="overview-wrap">
                                   <center> <h1><i class="fas fa-list-alt"></i> &nbsp Customer Details </h1> </center>
                                </div>
                                <hr><br>                                
                            </div>
                        </div>
                        <?php
                            ...
                            if(isset($_GET['edit'])){
                                    ...
                                    $edit_id = $_GET['edit'];
                                    $get_customer = "select * from customer_account where cid = '$edit_id'";

                                    $run_edit_customer = mysqli_query($conn , $get_customer);
                                    $row_customer = mysqli_fetch_array($run_edit_customer);
                                    ...
                                    <center>
                                        <form action='customer_edit.php' method='post' enctype='multipart/form-data' class='form-horizontal' >
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='firstname' value='$firstname' class='form-control' readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='lastname' value='$lastname' class='form-control' readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='address' value='$address' class='form-control' readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='number' id='text-input' name='telephone' value='$telephone'  class='form-control' readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='email' value ='$email ' class='form-control' readonly>
                                                  </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='email' id='text-input' name='password' value='$password' class='form-control' readonly>
                                                  </div>
                                            </div>

                                             <div class='row form-group'>
                                                <div class='col col-md-3'>
                                                    <label for='select' class='form-control-label'>Photo</label>
                                                </div>
                                                <div class='col-12 col-md-9'>
                                                    <img align='left' style='border-radius:25px' src='$cphoto' width='200' height='100'>
                                                </div>
                                            </div>                                        
                                        
                                    </div>
                                    <div class='card-footer'>
                                        <a href='customer_edit.php?edit=$cid'>
                                        <button  class='btn btn-primary btn-sm'>
                                            Update
                                        </button></a> &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp

                                        <a href='customer_pdf/customer_report.php?edit=$cid'>
                                        <button style='background-color:green' class='btn btn-danger btn-sm'>
