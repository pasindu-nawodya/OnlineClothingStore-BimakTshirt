        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <?php
                            ...
                            if(isset($_GET['edit'])){
                                    ...
                                    $run_edit_veh = mysqli_query($conn , $get_veh);
                                    $row_veh = mysqli_fetch_array($run_edit_veh);
                                        ...
                                        <form action='item_edit.php' method='post' enctype='multipart/form-data' class='form-horizontal' >
                                           ...
                                           <div class='row form-group'>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <input type='text' id='text-input' name='vreg_no' value='$vreg_no' class='form-control' readonly>
                                                  </div>
                                            </div> 
                                           ...
                                           <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <textarea name='vdesc' id='textarea-input' rows='9' class='form-control' readonly> $vdesc</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class='row form-group'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <img src='$iphoto' width='300px' height='141px' style='border-radius: 50%'>
                                                </div>
                                            </div>                                       
                                    ...
                                    <div class='card-footer'>
										...
										<a href='vehicle_pdf/vehiclerp.php?edit=$vehicle_id'>
										<button class='btn btn-primary btn-sm' style='background-color:green'>Report</button></a>
                                        &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp
										
                                        <a href='list_vehicle.?edit=$vehicle_id'>
                    ...
                    <div class="report">
	                    <form class="form-inline" method="post" action="vehicle_pdf/vehiclerp.php">
                        </form>
		            </div> 
                            <div class="row">
                            <div class="col-md-12">
