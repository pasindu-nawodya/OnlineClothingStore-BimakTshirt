        ...
        <div class="page-container">
                    ...
                    <div class="container-fluid">
                        <div class="row">
							...
							<div class="overview-wrap">
                                   <center> <h1><i class="fas fa-tag"></i> Add Category </h1> </center>
                                </div>
								<hr><br>                                
                            </div>
                        </div>
            ...
            <?php
                    ...
                    echo "
                         <div>
                                <div class='table-responsive  m-b-30'>
                                    <table class='table table-borderless table-striped table-earning' style='width:50%;'>
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                                <th>Category</th>
                    ...
                    echo "
                            <tr>
                                ...
                                <td align='center'>
                                    ...
                                    <a href='del_category.php?del=$id'>
                ...
                ?>
                        ...
                        <center>
                        <form action="add_category_php.php" method="post" enctype="multipart/form-data" class="form-horizontal" >
                        <div style="width:65%;border-radius:25%;">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Add Category to the System</strong>
                                    </div>
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="category" placeholder="category" class="form-control" required>
                                                  </div>
                                            </div>
