...
{  
	...
	if(mysqli_query($con,"INSERT INTO vehicle(vreg_no,v_type,vdesc,iphoto) VALUES ('$vreg_no','$v_type','$vdesc','$iphoto')"))
	{
...
{
var a = document.forms["myForm"]["vreg_no"].value;
    if (a == "")
    {
        alert("Vehicle Reg Number must be filled out!");
        return false;
    }
	var b = document.forms["myForm"]["vfile"].value;
    if (b == "")
    {
                    ...
                    <div class="container-fluid">
                        <div class="row">
							...
							<div class="overview-wrap">
                                   <center> <h1><i class="fas fa-plus"></i> &nbsp Add Vehicle </h1> </center>
                                </div>
								<hr><br>                                
                            </div>
                        </div>
                        ...
                        <center>
                         ...
                         <form action="add_vehicle.php" method="post" name="myForm" onsubmit="return validateForm()"  enctype="multipart/form-data" class="form-horizontal" >
                        <div style="width:65%;border-radius:25%;">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Add Vehicle to the System</strong>
                                    </div>
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="vreg_no" placeholder="Vehicle Reg Num" class="form-control" >
                                           ...
                                           <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="vdesc" id="textarea-input" rows="9" placeholder="Content..." class="form-control"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="file" id="file-input" name="vfile" class="form-control-file">
                                                </div>
                                            </div>                                           
                                        
                                    </div>
                                    <div class="card-footer">
                                        <input type="submit"   name="add" class="btn btn-primary btn-sm" value="submit">
